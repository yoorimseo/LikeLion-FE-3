...
"frodo".match(/fro../g); // ['frodo']
"frodot".match(/fro../g); // ['frodo']
"frotdot".match(/fro../g); // ['frotd']
"ftrotdot".match(/fro../g); // null
"aafrotdot".match(/fro../g); // ['frotd']
"abcdo".match(/....o/g); // ['abcdo']
"abcdok".match(/....o/g); // ['abcdo']
"dok".match(/....o/g); // null

// -- section 2 --
let 패턴 = new RegExp('fro..', 'g') "frodo".match(패턴)
// ['frodo'];
"ftrotdot".match(패턴); // null

let 패턴 = new RegExp('fro..', 'g');
패턴.test("frodo"); // 우리한테 필요한 것은 boolean 값, true
